...
cat > "$DESKTOP_FILE" <<EOF_DESKTOP
	...
	Exec=/bin/bash "/home/mintpi/Documents/PiModoro/PiModoro (mine)/run.sh"
	Path=/home/mintpi/Documents/PiModoro/PiModoro (mine)
	Icon=/home/mintpi/Documents/PiModoro/PiModoro (mine)/misc/pomo.png
	Terminal=false
	Type=Application
